...
public class PizzaBakedModel implements BakedModel {
    ...
    protected static final float[][][] ADDITIONAL_VECTORS_SQUARE = new float[][][]
            {
                    ...
                    {
                            {8.0F, 1.0F, 8.0F}, //1/4 Square
                    }
            };

    protected static final float[][][] ADDITIONAL_UV_SQUARE = new float[][][]
            {
                    {
                            {1.0F, 1.0F, 8.0F, 8.0F},
                    },
    ...
    protected static final float[][][] VECTORS_SQUARE = new float[][][]
            {
                    {
                            {1.0F, 1.0F, 1.0F}, //Full Square
                            {8.0F, 1.0F, 1.0F}, //Half Square
                            {8.0F, 1.0F, 1.0F}, //Half Square
                            {8.0F, 1.0F, 8.0F}, //1/4 Square
                    },
                    {
                            {15.0F, 1.0F, 15.0F}, //Full Square
                            {15.0F, 1.0F, 15.0F},  //Half Square
                            {15.0F, 1.0F, 15.0F},  //Half Square
                            {15.0F, 1.0F, 15.0F}, //1/4 Square
                    }
            };

    protected static final float[][][] UV_SQUARE = new float[][][]
            {
                    {
                            {1.0F, 1.0F, 15.0F, 15.0F},
                            {8.0F, 1.0F, 15.0F, 15.0F},
                            {8.0F, 1.0F, 15.0F, 15.0F},
                            {8.0F, 8.0F, 15.0F, 15.0F}
                    },
                    {
                            {1.0F, 1.0F, 15.0F, 15.0F},
                            {1.0F, 1.0F, 15.0F, 8.0F},
                            {1.0F, 1.0F, 15.0F, 8.0F},
                            {1.0F, 1.0F, 8.0F, 8.0F}
                    },
                    {
                            {1.0F, 1.0F, 15.0F, 15.0F},
                            {1.0F, 1.0F, 8.0F, 15.0F},
                            {1.0F, 1.0F, 8.0F, 15.0F},
                            {1.0F, 1.0F, 8.0F, 8.0F}
                    },
                    {
                            {1.0F, 1.0F, 15.0F, 15.0F},
                            {1.0F, 8.0F, 15.0F, 15.0F},
                            {1.0F, 8.0F, 15.0F, 15.0F},
                            {8.0F, 8.0F, 15.0F, 15.0F}
                    }
            };
    ...
    private List<BakedQuad> getLayerQuads(IItemHandler inventory, int integerProperty, boolean isRaw, RandomSource randomSource) {
        ...
        for(int i = 0; i < layers.size(); i++)
        {
            ...
            // VECTORS[integerProperty][0], VECTORS[integerProperty][1], VECTORS[integerProperty][2],
            // VECTORS[7][0], VECTORS[7][1], VECTORS[7][2], tintIndexes.get(i)));

            builder.add(getQuadForLayer(layers.get(i), Direction.UP, rotation, UV_SQUARE[(rotation / 90) % 4][integerProperty],
                    VECTORS_SQUARE[0][integerProperty][0], VECTORS_SQUARE[0][integerProperty][1], VECTORS_SQUARE[0][integerProperty][2],
                    VECTORS_SQUARE[1][integerProperty][0], VECTORS_SQUARE[1][integerProperty][1], VECTORS_SQUARE[1][integerProperty][2], tintIndexes.get(i)));

            //Build additional quad
            if(integerProperty == 1) {
                builder.add(getQuadForLayer(layers.get(i), Direction.UP, rotation, ADDITIONAL_UV_SQUARE[(rotation / 90) % 4][0],
                        ADDITIONAL_VECTORS_SQUARE[0][0][0], ADDITIONAL_VECTORS_SQUARE[0][0][1], ADDITIONAL_VECTORS_SQUARE[0][0][2],
                        ADDITIONAL_VECTORS_SQUARE[1][0][0], ADDITIONAL_VECTORS_SQUARE[1][0][1], ADDITIONAL_VECTORS_SQUARE[1][0][2], tintIndexes.get(i)));
            }
        }
